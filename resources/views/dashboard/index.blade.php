      ...
      <div class="widget-box-content">
        ...
        <p class="widget-box-text mb-2">
          <span id="english-text" style="display: inline;">
            This revenue estimate is a projection and may differ from actual earnings. Final earnings for this month will
            be finalized on the 3rd day of the following month.
          </span>
          <span id="indonesian-text" style="display: none;">
            Estimasi pendapatan ini merupakan proyeksi dan mungkin berbeda dari pendapatan aktual. Pendapatan akhir kamu
                    ...
                    <div class="user-avatar small no-outline">
                      <div class="user-avatar-content">
                        <div class="hexagon-image-30-32"
                          ...
                          style="width: 30px; height: 32px; position: relative;"><canvas width="30" height="32"
                            style="position: absolute; top: 0px; left: 0px;"></canvas></div>
                      </div>
