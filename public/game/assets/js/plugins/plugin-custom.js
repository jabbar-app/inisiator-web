  ...
  onboardingStepsSlider &&
    onboardingStepsSlider.forEach(function (onboardingStepsSlider) {
      ...
      swiper.on("reachEnd", function () {
        swiperNavButtonText.innerHTML = `<a href="/register" class="text-white py-4 bg-p2 font-semibold block rounded-full text-center px-6 text-base text-nowrap ">Get Started</a>`;
      });
    });
